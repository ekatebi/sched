...
export const secDb = 'https://zv-sec.firebaseio.com';
...
const backEndHostIp = '172.16.200.199';
export const backEndHost =
  (process.env.NODE_ENV === 'development') ? backEndHostIp : window.location.hostname;
