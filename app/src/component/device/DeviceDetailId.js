...
export default class DeviceDetailId extends Component {
  ...
  setName(mac, name) {
    ...
    .catch(error => {
      appAlert.error(`Failed to set name of ${name} for device with mac address of ${mac}, ${error}`,
        { time: 0 });
    });
  }
  ...
  setManufacturer(mac, manufacturer) {
    ...
    .catch(error => {
      appAlert.error(`Failed to set manufacturer of ${manufacturer} for device with mac address of ${mac}, ${error}`);
    });
  }
  ...
  setModel(mac, model) {
    ...
    .catch(error => {
        appAlert.error(`Failed to set model of ${model} for device with mac address of ${mac}, ${error}`,
          { time: 0 });
    });
  }
  ...
  setSerialNumber(mac, serialNumber) {
    ...
    .catch(error => {
      appAlert.error(`Failed to set serialNumber of ${serialNumber} for device with mac address of ${mac}, ${error}`,
        { time: 0 });
    });
  }
  ...
  setLocation(mac, location) {
    ...
    .catch(error => {
        appAlert.error(`Failed to set location of ${location} for device with mac address of ${mac}, ${error}`,
          { time: 0 });
    });
  }
